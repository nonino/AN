...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <?php echo form_open('Edit_profile/editClinet'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="firstname" value="<?= $user->client_first_name ?>" class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="text" name="lastname" value="<?= $user->client_last_name ?>" class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobile" value="<?= $user->client_mobile ?>" class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="text" name="tele" value="<?= $user->client_tele ?>" class="form-control"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="5" id="comment" name="notes" ><?= $address->address_note ?></textarea>
                <br>
